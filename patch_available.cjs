    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2.5">
          ...
          <h3 className="text-xs font-black text-text-main uppercase tracking-wider">
            {t('free_time_available_today') || 'Available Today'}
          </h3>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="flex flex-col gap-1">
          ...
          <span className="text-sm font-black text-emerald-500 font-mono">{totalHours}</span>
        </div>
        ...
        <div className="flex flex-col gap-1 border-l border-surface-border pl-3">
          ...
          <span className="text-sm font-black text-emerald-500 font-mono">{slotsCount}</span>
        </div>
...
fs.writeFileSync('src/components/AvailableTodayWidget.tsx', content, 'utf-8');
console.log("Updated AvailableTodayWidget");
